...
//		System.out.println(i);
		...
		if(reservation_id!=0) {
			...
			snackUpdate=paymentMapper.snackBasketPayUpdate(paramMap);
		}
		
		
		
		return insertPay+snackUpdate+reservationUpdate   +memPoint;  //정상적인 처리가 완료되었을때 항상 2가 반환되어야 한다.
