			...
			<div class="container">
				  ...
				  <table class="table">
				    	...
				    	<tbody>
				                ...
				                <th>영화 포스터  :  </th>
					                <td>
						                <input type="text" placeholder="포스터를 등록하세요 " name="" value=""/>
  			          ...
  			          <tr>
				                <th>영화 트레일러  :  </th>
				                <td><input type="text" placeholder="영화 트레일러를 등록하세요 " name="movie_trailer" value=""/>
				                		<input type="button" value="전송"  onclick=""/>
				                			<form action="fileUpload" method="post" enctype="Multipart/form-data"> <br>
											        파일명1 : <input type="file" name="fileName1" /> </br>
											        <input type="submit" value="전송" />  
  			          ...
  			          <tr>
				                <th>영화 스틸컷  :  </th>
				                <td><input type="text" placeholder="영화 스틸컷을 등록하세요 " name="stillcut" value=""/>
				                		<form action="fileUpload" method="post" enctype="Multipart/form-data"> <br>
