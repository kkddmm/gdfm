...
<c:if test="${isError}">
	<script type="text/javascript">
		...
		history.pushState(null,"","${pageContext.request.contextPath}/admin/memberForm?type=${param.type}");
	</script>
</c:if>
...
$(function(){
	...
	$("#btnIdCheck").click(function() {
		if($("input[name=mem_id]").val()){
			...
			$.ajax({
				type: 'post',
				url : '${pageContext.request.contextPath}/admin/memberExists',
				data : "mem_id=" + mem_id,
...
<div class="slider">
	<div>
		...
		<table class="table table-bordered table-striped">
			...
			<tr>
				<th class="warning text-center">회원성별</th>
				<td>
					<c:if test="${param.type == 'I'}">
			...
			<tr>
				<th class="warning text-center">회원주소</th>
				<td>
			...
			<tr>
				<th class="warning text-center">회원등급</th>
				<td>
					<div class="col-xs-2">
			...
			<tr>
				<th class="warning text-center">회원포인트</th>
